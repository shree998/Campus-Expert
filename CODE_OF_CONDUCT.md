...
If you feel uncomfortable or unwelcome, and would like to talk to a member of staff, then please follow the following steps so that we can help you as quickly as possible:
...
for handling Code of Conduct violations in the repository.

2\. Report the Code of Conduct violationto a staff member. All reports are confidential. Please do not disclose public information about the incident until the staff have had sufficient time in which to address the situation. This is as much for your safety and protection as it is for the other students.
...
- Identifying information (GitHub handle/link to where it occurred) of the participant violating the CoC.
...
Try to get as much of the incident in writing from the reporter. If you cannot, transcribe it yourself as it was told to you. The important information to gather include the following:
 ...
 - Identifying information (GitHub handle/link to place incident occurred) of the participant violating the CoC.
 - The behavior that was in violation.
 - The approximate time of the behavior (if different than the time the report was made).
 - The circumstances surrounding the incident.
 - Other people involved in the incident.
...
After the staff meeting and discussion, have a staff member communicate with the participant alleged offender. Make sure to inform them of what has been reported about them.

Allow the alleged offender to give their side of the story to the staff. After this point, if the report stands, let the alleged offender know what actions will be taken against them.

Some things for the staff to consider when dealing with Code of Conduct offenders:

- Warning the violator to cease their behavior and that any further reports will result in sanctions.
- Requiring that the offender avoid any interaction with their victim for the remainder of their participation in the program.
...
- Immediately ending any event volunteer responsibilities and privileges the offended holds.
- Requiring that the offender not volunteer for future Campus Expert activities (either indefinitely or for a certain time period).
- Requiring that the offender immediately leave the project and not return.
- Banning the offender from future events and programs (either indefinitely or for a certain time period).
- Removing a offender from membership of relevant organisations and repositories.
- Publishing an account of the violation and calling for the resignation of the offender from their responsibilities (usually pursued by people without formal authority: may be called for if the offender is the event leader, or refuses to stand aside from the conflict of interest, or similar, typically event staff have sufficient governing rights over their space that this isn't as useful).

Give accused attendees a place to appeal to if there is one, but in the meantime the report stands. Keep in mind that it is not a good idea to encourage an apology from the offender.
...
If some attendees were angered by the incident, it is best to apologize to them that the incident occurred to begin with.
